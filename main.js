/* =========================================================================
   FOR YOU 🌸 — v3.1 interactive experience
   Sections:
   0. Preloader
   ...
   8. Ambient music toggle (WebAudio)
   9. Main render loop
   ========================================================================= */
...
(() => {
  ...
  window.addEventListener("pointerdown", (e) => {
    if (e.target.closest("#music-toggle, #envelope-screen, #hidden-note, #message-panel, #ui-controls")) return;
